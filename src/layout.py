...
def create_layout(IP, chat):    
    layout = [
        ...
        [sg.Text('Criptografia:'), sg.Combo(key='encryption_method', values=['S-DES', 'RC4'], enable_events=True, size=(10,1)), sg.Text('Chave:'), sg.Input(key='key', do_not_clear=True, enable_events=True, size=(22,25))],
